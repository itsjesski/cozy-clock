...
### Added
- Add timer notification settings and enhance timer controls
...
### Added
- Enhance pointer events for flip content in TimerTile
...
### Added
- Improve input handling in CreateTimerModal and SettingsPanel
